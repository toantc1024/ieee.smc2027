...
/**
 * Official MagicUI Progressive Blur Component.
 * Adds a multi-layered progressive optical blur gradient to scrollable containers,
 * eliminating harsh rectangular blur borders through staggered, overlapping mask gradients.
 */
export function ProgressiveBlur({
  ...
  return (
    <div
      className={`gradient-blur pointer-events-none absolute inset-x-0 z-20 ${positionClasses} ${className}`}
      style={{
    ...
    >
      ...
      {/* Middle blur layers with staggered overlapping mask intervals */}
